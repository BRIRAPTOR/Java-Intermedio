 ...
 * @author brian
 */
public class GraficaDeBarrasPorcetual extends javax.swing.JFrame {

    /**
     * Creates new form GraficaDeBarrasPorcetual
     */
    public GraficaDeBarrasPorcetual() {
        initComponents();
...
boolean bandera = false;
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txt_rojo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
                            .addComponent(txt_azul)
                            .addComponent(txt_verde, javax.swing.GroupLayout.Alignment.LEADING))
                        .addGap(107, 107, 107)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraficaDeBarrasPorcetual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new GraficaDeBarrasPorcetual().setVisible(true);
        });
    }
    ...
    if(bandera = true){
        ...
        g.drawString(porcentaje_rojo + "%", 55, 150);
        
        g.setColor(new Color(0,130,0));
        g.fillRect(50 + largo_rojo, 120, largo_verde, 50);
        g.setColor(new Color(255,255,255));
        g.drawString(porcentaje_verde + "%", 55 + largo_rojo, 150);
        
        g.setColor(new Color(0,0,255));
        g.fillRect(50 + largo_rojo + largo_verde, 120, largo_azul, 50);
        g.setColor(new Color(255,255,255));
        g.drawString(porcentaje_azul + "%", 55 + largo_rojo + largo_verde, 150);
