...
public class Informacion_Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_footer.setText("Creado por Briraptor ©2023");
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "¡¡Error al obtener los datos del cliente!!, contacte al administrador.");
                }
            ...
            System.err.println("Error en PDF o en ruta de imagen " + e);
            JOptionPane.showMessageDialog(null, "¡¡Error en generar PDF!!, contacte al administrador.");
        }
