...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        Icon icono_logo = new ImageIcon(wallpaper_logo.getImage().getScaledInstance(jLabel_Logo.getWidth(), jLabel_Logo.getHeight(),
                Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(91, 480, 210, -1));
