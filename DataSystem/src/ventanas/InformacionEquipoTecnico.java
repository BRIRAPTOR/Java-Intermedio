...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    public InformacionEquipoTecnico() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                año = rs.getString("annio_ingreso");

                txt_fecha.setText(dia + " del " + mes + " del " + año);
                ...
                jLabel_revicionTecnicaDe.setText("Comentarios y actualización del tecnico: " + rs.getString("revision_tecnica_de"));

            }

        } catch (SQLException e) {
            System.err.println("Error al consultar información del equipo." + e);
        }
    ...
    private void initComponents() {
        ...
        jLabel_revicionTecnicaDe = new javax.swing.JLabel();
        ...
        jLabel_revicionTecnicaDe.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_revicionTecnicaDe.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_revicionTecnicaDe.setText("Comentarios y actualizacion de técnico:");
        getContentPane().add(jLabel_revicionTecnicaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 260, -1, -1));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        String estatus, comentariosTecnico, tecnico;

        estatus = cmb_estatus.getSelectedItem().toString();
        comentariosTecnico = jTextPane_comentariosTecnico.getText();
        tecnico = user;

        try {
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement("update equipos set estatus = ?, comentarios_tecnicos = ?, revision_tecnica_de = ? where id_equipo = '" + IDequipo + "'");

            pst.setString(1,estatus);
            pst.setString(2,comentariosTecnico);
    ...
    private javax.swing.JLabel jLabel_revicionTecnicaDe;
