 ...
 * @author brian
 */
public class InformaciónUsuario extends javax.swing.JFrame {
String user = "", user_update = "";
int ID;
    /**
     * Creates new form InformaciónUsuario
     */
    public InformaciónUsuario() {
        initComponents();
        user = Login.user;
        ...
        jLabel_Titulo.setText("Información de usuario " + user_update);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformaciónUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformaciónUsuario().setVisible(true);
            }
        });
    }
