...
public int EstatusMasRepetido(int NuevoIngreso, int NoReparado, int EnRevision, int Reparado, int Entregado){
        ...
        return NuevoIngreso;
    } else if (NoReparado > NuevoIngreso && NoReparado > EnRevision && NoReparado > Reparado && NoReparado > Entregado) {
        return NoReparado;
    } else if (EnRevision > NuevoIngreso && EnRevision > NoReparado && EnRevision > Reparado && EnRevision > Entregado) {
        return EnRevision;
    } else if (Reparado > NuevoIngreso && Reparado > NoReparado && Reparado > EnRevision && Reparado > Entregado) {
        return Reparado;
    } else if (Entregado > NuevoIngreso && Entregado > NoReparado && Entregado > EnRevision && Entregado > Reparado) {
        return Entregado;
    } else {
