...
public class RegistrarEquipo extends javax.swing.JFrame {
    ...
    private void jButton_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistrarActionPerformed
        int validacion = 0;
        String tipo_equipo, marca, modelo, num_serie, dia_ingreso, mes_ingreso, año_ingreso, estatus, obsevaciones;
        ...
        obsevaciones = jTextPane_observaciones.getText();
        ...
        año_ingreso = Integer.toString(calendar.get(Calendar.YEAR));
        ...
        if (obsevaciones.equals("")) {
            jTextPane_observaciones.setText("Sin obsevaciones.");
        ...
        if (validacion == 0) {
            try {
                ...
                pst.setString(9, año_ingreso);
                pst.setString(10, obsevaciones);
                ...
                System.err.println("Error en registar equipo. " + e);
                JOptionPane.showMessageDialog(null, "¡¡Error al registrar equipo!!, contacte con el administrador.");
            }
        } else {
            JOptionPane.showMessageDialog(null, "Deves de llenar todos los campos.");
        }
